...
import { translatorsRestRouter } from "./translators.js";
...
import { paymentConfigRestRouter } from "./payment-config.js";
...
restRouter.use("/translators", translatorsRestRouter);
...
restRouter.use("/payment/config", paymentConfigRestRouter);
