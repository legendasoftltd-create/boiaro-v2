...
INSERT INTO "homepage_sections" ("id", "section_key", "title", "subtitle", "is_enabled", "sort_order")
SELECT gen_random_uuid(), v.section_key, v.title, v.subtitle, true, base.next_order + v.offset
FROM (VALUES
...
) AS v(section_key, title, subtitle, offset),
