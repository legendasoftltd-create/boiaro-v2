    ...
    {/* <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        ...
        <div className="bg-gray-200 px-6 py-8">
                <div className="max-w-screen-lg mx-auto grid md:grid-cols-2 items-center gap-6">
                  <div className="max-w-sm">
                    <h3 className="text-slate-900 text-xl font-bold mb-2">Subscribe to Our Newsletter</h3>
                    <p className="text-slate-600 text-sm leading-relaxed">{followUsText}</p>
                  </div>

                  <div className="max-w-md relative flex items-center p-1.5 bg-white border border-gray-300 rounded-md">
                    <input type="email" placeholder="Email Address"
                      className="px-3 py-3 text-slate-900 w-full text-sm bg-transparent outline-0" />
                    <button type="button"
                      className="px-6 py-3 rounded-sm text-white text-sm font-medium tracking-wider border-0 outline-0 bg-[#F68B1E] hover:bg-[#e57a1b] active:bg-[#d4691a] cursor-pointer">Subscribe</button>
                  </div>
                </div>
          </div>
            ...
            <div className="max-w-screen-xl mx-auto">
              ...
              <div className='grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
                <div className='flex items-center gap-6'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-purple-600" viewBox="0 0 512 512">
                  ...
                  <div>
                    <h6 className="text-purple-600 text-base font-semibold">Free Shipping</h6>
                    <p className='text-slate-900 text-sm mt-1'>On Orders Above Condition apply</p>
                  </div>
                </div>
                <div className='flex items-center gap-6'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-purple-600 stroke-purple-600" viewBox="0 0 682.667 682.667">
                    <defs>
                  ...
                  <div>
                    <h6 className="text-purple-600 text-base font-semibold">100% Secure</h6>
                    <p className='text-slate-900 text-sm mt-1'>Checkout</p>
                  </div>
                </div>
                <div className='flex items-center gap-6'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-purple-600 stroke-purple-600" viewBox="0 0 682.667 682.667">
                  ...
                  <div>
                    <h6 className="text-purple-600 text-base font-semibold">Outstanding</h6>
                    <p className='text-slate-900 text-sm mt-1'>Wordwide support</p>
                  </div>
                </div>
                <div className='flex items-center gap-6'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-purple-600" viewBox="0 0 511.987 511">
                  ...
                  <div>
                    <h6 className="text-purple-600 text-base font-semibold">Over 1,000</h6>
                    <p className='text-slate-900 text-sm mt-1'>Genuine reviews</p>
                  </div>
                </div>
              </div>
