...
// highest-discount first — see server/src/services/books.service.ts.
// Independent of the page's global content filter — this section has its
// own All/eBooks/Audio/Print toggle.
  ...
  return (
    <section className="section-container bg-gradient-to-b from-red-500/[0.03] via-background to-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        {books.length === 0 ? (
          <p className="text-sm text-muted-foreground py-6">No special offers match this filter yet.</p>
        ) : (
        ...
        <div className="text-center mt-5 md:mt-8">
          <Link to="/books"><Button variant="outline" className="border-red-500/40 text-red-500 hover:bg-red-500 hover:text-foreground h-10 px-6 rounded-xl font-semibold text-[13px] transition-all duration-200">সব দেখুন →</Button></Link>
        </div>
      </div>
    </section>
  )
