...
import { calcFullUnlockCost, DEFAULT_COINS_PER_CHAPTER, type TrackWithChapterPrice } from "@/lib/audiobookPricing";
...
interface TrackWithPrice extends AudioTrack, TrackWithChapterPrice {}
