...
import { BookOpen, Users, Languages, Search, ChevronLeft, ChevronRight } from "lucide-react";
...
const TranslatorsPage = () => {
  ...
  const { translators, total } = useTranslators({ page, pageSize: PAGE_SIZE, search });
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-20 pb-10">
        ...
        {translators.length === 0 ? (
          <p className="text-sm text-muted-foreground py-10 text-center">No translators match this search.</p>
        ) : (
        ...
        {translators.length > 0 && totalPages > 1 && (
