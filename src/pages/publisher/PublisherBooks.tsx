...
export default function PublisherBooks() {
  ...
  const openEdit = (book: any) => {
    ...
    setForm({ ...emptyForm(), title: book.title || "", description: book.description || "", cover_url: book.cover_url || "", tags: (book.tags || []).join(", "), price: fmt?.price?.toString() || "", stock_count: fmt?.stock_count?.toString() || "", binding: fmt?.binding || "" });
    setOpen(true);
  };
