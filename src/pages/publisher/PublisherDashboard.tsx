...
import { BookOpen, Package, DollarSign, Wallet, Clock, Headphones, RefreshCw, Building2 } from "lucide-react";
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base flex items-center gap-2">
              <Building2 className="w-4 h-4 text-primary" /> Recent Publications
            </CardTitle>
            <Link to="/creator/inventory" className="text-xs text-primary hover:underline">View All</Link>
          </div>
        </CardHeader>
        <CardContent>
          {booksLoading ? (
